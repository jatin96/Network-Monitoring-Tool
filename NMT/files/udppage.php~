...
<div id="wrapper">
  ...
  <a class="link-3" href="ipv4page.php">Refresh</a>
...
<div class="head">ARP table</div>
			...
			<p>	
			<?php
					system("chmod 777 /var/www/html/script_udp.sh");
					system("/var/www/html/script_udp.sh");
					$con=dbconnect();
					...
					//echo "row-->".$num;
					//echo "hello!*123";echo "<br>";
					echo "total no. of rows = 32";echo '<br>';
